#ifndef Classic_Samples_Components_Graphics_H
#define Classic_Samples_Components_Graphics_H
		...
		namespace Components {
			...
			*/
			...
			public:
				...
				*/
				bool accept(Classic::Messages::CMessage *message) const;

				/**
				Processes a message in which this component is interested.
				*/
				void process(Classic::Messages::CMessage *message);
